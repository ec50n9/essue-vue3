...
<template>
  <div v-if="visible" id="toast-default"
       class="toast my-2 flex items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
       role="alert">
    ...
    <div class="mx-4 text-sm font-normal">{{ message }}</div>
